...
" +             Jing Huang <RadioNoiseE@gmail.com>
" Last Change:  Nov 1, 2023
" Version:      121
" URL:          http://www.drchip.org/astronaut/vim/index.html#SYNTAX_TEX
" +             https://www.github.com/RadioNoiseE/vim-expl3
"
" Notes: {{{1
"
...
elseif b:tex_stylish
  let b:tex_isk="@,48-57,a-z,A-Z,192-255,:,_"
else
...
if exists("g:tex_tex") || b:tex_stylish
  syn match texStatement  "\\[a-zA-Z@_]\+\:*[nNpTFDw]?"
else
...
if b:tex_stylish
  syn match texDefName  contained  "\\[a-zA-Z@_]\+\:*[nNpTFDw]?"  nextgroup=texDefParms,texCmdBody  skipwhite  skipnl
